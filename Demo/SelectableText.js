...
export const SelectableText = ({
  ...
  const onSelectionNative = ({
    ...
    const newHighlight = { start: selectionStart, end: selectionEnd };
    const mergedSelections =
      props.highlights &&
      props.highlights.map((value, i) =>
        i === highlighedSelectionIndex ? newHighlight : value
      );
    ...
    onSelection &&
      onSelection({
        ...
        selectionStart,
        selectionEnd,
        isUpdate: highlighedSelectionIndex !== -1,
        mergedSelections,
        id: props.id,
      });
  };
